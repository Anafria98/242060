...
namespace _200038_20371
{
    public class Banco
    {
        ...
        public static void AbrirConexao()
        {
            try
            {
                Conexao = new MySqlConnection("server=localhost;port=3306;uid=root;pwd=18050088Gv@;database=vendas");
                Conexao.Open();
            }
            catch(Exception e){
                MostrarErro(e);
        ...
        public static void CriarBanco()
        {
            try
            {
                MySqlConnection conexaoTemp = new MySqlConnection("server=localhost;port=3306;uid=root;pwd=18050088Gv@");
                conexaoTemp.Open();
